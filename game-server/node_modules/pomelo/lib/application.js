...
Application.init = function(opts) {
  ...
  this.set(Constants.Reserved.BASE, opts.base);
...
Application.getBase = function() {
  return this.get(Constants.Reserved.BASE) || process.cwd();
};
...
Application.before = function (bf) {
  var befores = this.get(Constants.KeyWords.BEFORE_FILTER);
  if(!befores) {
    befores = [];
    this.set(Constants.KeyWords.BEFORE_FILTER, befores);
  }
  befores.push(bf);
  return this;
};
...
Application.after = function (af) {
  var afters = this.get(Constants.KeyWords.AFTER_FILTER);
  if(!afters) {
    afters = [];
    this.set(Constants.KeyWords.AFTER_FILTER, afters);
  }
  afters.push(af);
  return this;
};
...
Application.globalBefore = function (bf) {
  var befores = this.get(Constants.KeyWords.GLOBAL_BEFORE_FILTER);
  if(!befores) {
    befores = [];
    this.set(Constants.KeyWords.GLOBAL_BEFORE_FILTER, befores);
  }
  befores.push(bf);
  return this;
};
...
Application.globalAfter = function (af) {
  var afters = this.get(Constants.KeyWords.GLOBAL_AFTER_FILTER);
  if(!afters) {
    afters = [];
    this.set(Constants.KeyWords.GLOBAL_AFTER_FILTER, afters);
  }
  afters.push(af);
  return this;
};
...
Application.start = function(cb) {
  ...
  var self = this;
  appUtil.optComponents(this.loaded, Constants.Reserved.START, function(err) {
